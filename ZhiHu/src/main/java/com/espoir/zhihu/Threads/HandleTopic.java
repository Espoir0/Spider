...
public class HandleTopic extends Thread
{
     ...
     public void run() {
         try {
				...
				{		
					...
					if (entity != null)
					{
						...
						while (m.find())
						{
							...
							String s = m.group();
							System.out.println("topicIDΪ:"+s.substring(7)+"���");

							count++;
							Util.SecondtopicID.add(s.substring(7));
						}
						  
						System.out.println("topicidΪ"+topicid+"��offset="+offset);
						offset=offset+20;
			...
			System.out.println("Thread--------------------------------------:"+topicid+"��ȡ����:"+count);

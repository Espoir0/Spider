...
import com.espoir.zhihu.user.User;
...
public class GerUserInfoThread extends Thread {

    private final CloseableHttpClient httpClient;
    private final HttpContext context;
    private final HttpGet httpget;

    public GerUserInfoThread(CloseableHttpClient httpClient, HttpGet httpget) {
    ...
    public void saveToDB(User user) throws SQLException {
        ...
        String sql = "insert into user(username,sex,location,bussiness,employment,postion,education,education_extra,suppose,thanks,question,answer,article,followers,following,bewatched)"
                + " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            try {
                ...
                if (entity != null) {
                    ...
                    String regex = "(<title>.*</title>)|(data-gender=\".\")|(location item\" title=.{0,30}\">)|(business item\" title=.{0,30}\">)|"
                            ...
                            + "(education-extra item\" title=.{0,30}>)|" + "([0-9]*</strong>��ͬ)|" + "([0-9]*</strong>��л)|" + "(����\\n<span class=\"num\">[0-9]*)|" + "(�ش�\\n<span class=\"num\">[0-9]*)|"
                            + "(����\\n<span class=\"num\">[0-9]*)|" + "(��ע��</span><br />\\n<strong>[0-9]*)|" + "(��ע��</span><br />\\n<strong>[0-9]*)|"
                            + "(������ҳ�� <strong>[0-9]*)|" + "(<title>.*</title>)|" + "(data-gender=\".\")";
